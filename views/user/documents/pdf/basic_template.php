...
<div class="grey-bg ta-r">
	<h1 style="font-size: 30px;" class="pr-4 p-2"><?php echo strtoupper($documento); ?></h1>
</div>

<div class="pl-3 pr-3 mb-2">

	<?php $this->load->view('user/documents/pdf/basic_empresa') ?>
	<?php $this->load->view('user/documents/pdf/basic_cliente') ?>
	...
	<?php $this->load->view('user/documents/pdf/basic_partidas') ?>
